...
\resizebox{\columnwidth}{0.95cm}{%
  \begin{tabular}{|c ||c ||c |c | c| c| c|}
    ...
    \hline
    \textcolor{green}{Sample(size $n=2$)} & \textcolor{mycolor}{\{1,2\}} & \textcolor{mycolor}{\{1,3\} }& \textcolor{mycolor}{\{1,4\} }& \textcolor{mycolor}{\{2,3\}} & \textcolor{mycolor}{\{2,4\} }& \textcolor{mycolor}{\{3,4\}}\\
    \hline
  \end{tabular}%
} 
