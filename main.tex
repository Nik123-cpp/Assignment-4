...
$i: \hspace{1cm} 1 \hspace{1.2cm} 2 \hspace{1.3cm} 3 \hspace{1.4cm} 4$
\newline
$p_{i} \hspace{1cm} 0.4 \hspace{1cm} 0.2 \hspace{1cm}0.2 \hspace{1cm} 0.2$
\newline \newline
The probability of inclusion of unit (1) in the sample is 
\newline
$(1) 0.4 \hspace{4cm}(2) 0.6$
\newline
$(3) 0.7 \hspace{4cm}(4) 0.75$
\section{Solution }
...
\begin{align}
    ...
    \label{eq:eq2}
\end{align}
Let Probability of selecting sample i,j is $\pr{i,j}$,using \eqref{eq:eq2}  $\pr{i,j}$ is 
\begin{align}
...
\begin{align}
    \text{P}&=\pr{1,2} +\pr{1,3}+\pr{1,4}
\end{align}
using \eqref{eq:eq3} and $p_{i}$ from question ,
\begin{align}
    \text{P}&=\frac{7}{30} + \frac{7}{30} + \frac{7}{30}
    \\
    &=0.7
\end{align}
